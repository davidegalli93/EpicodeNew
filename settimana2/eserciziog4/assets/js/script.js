...
/* ESERCIZIO 5
  Inserisci l'oggetto dei personaggi in "starWarsCharacters" nell'array corrispondente al colore dei loro occhi nell'oggetto "eyeColor" 
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (starWarsCharacters[i].eye_color) {
    case "blue":
      eye_color.blue.push(starWarsCharacters[i].name);
      break;
    case 'yellow':
      eye_color.yellow.push(starWarsCharacters[i].name);
      break;
    case 'brown':
      eye_color.brown.push(starWarsCharacters[i].name);
      break;
    case 'red':
      eye_color.red.push(starWarsCharacters[i].name);
    case 'blue_gray':
      eye_color.blue_gray.push(starWarsCharacters[i].name);
      break;
  }
}
console.log(eye_color);
